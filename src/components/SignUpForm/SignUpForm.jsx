...
const SignUpForm = () => {
    ...
    // return
    return (
        <div className="flex flex-col border-2 border-e-gray-950 bg-white w-[90%] shadow-lg h-auto pb-5 rounded-lg items-center mt-5 mx-auto max-w-3xl">
            ...
            <form className="mt-4 w-[80%] md:text-lg" autoComplete="off" onSubmit={handleSubmit}>
                ...
                <button className={`flex px-5 py-2 mx-auto rounded-full transition-colors ${isSignUpValid() ? "bg-gray-400 cursor-not-allowed" : "bg-yellow-700 hover:bg-yellow-600 text-white"}`} disabled={isSignUpValid()}>Sign Up</button>
