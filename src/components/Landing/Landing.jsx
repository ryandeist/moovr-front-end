    ...
    return (
        <>
            <div className='flex flex-col lg:flex-row lg:h-[40%] p-5 lg:pt-10 items-top w-[100%] justify-around mx-auto max-w-7xl'>
                <section className='hidden lg:block content-center items-center flex-col pb-5 bg-white border-2 border-gray-950 w-[100%] lg:w-[40%] shadow-lg h-110 rounded-lg justify-items-center'>
